...
class Decoder(
    ...
    val sourceImageWidth: Int get() = imageWidth
    val sourceImageHeight: Int get() = imageHeight
    val sourceCrop: Rect get() = Rect(cropLeft, cropTop, cropLeft + cropWidth, cropTop + cropHeight)
